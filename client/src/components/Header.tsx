...
export default function Header() {
  ...
  const navItems: NavItem[] = [
    ...
    { label: t('uxTrack'), href: 'https://abdoemara175.github.io/Pixel-Community/sections/ux', isExternal: true },
    { label: t('uiTrack'), href: 'https://abdoemara175.github.io/Pixel-Community/sections/ui', isExternal: true },
    { label: t('integrationTrack'), href: 'https://abdoemara175.github.io/Pixel-Community/sections/ux-ui', isExternal: true },
    { label: t('bonusTrack'), href: 'https://abdoemara175.github.io/Pixel-Community/sections/bonus', isExternal: true },
  ];
