  ...
  const topics: Topic[] = [
    {
      ...
      steps: [
        {
          id: 'introduction',
          title: lang === 'ar' ? 'Introduction' : 'Introduction',
        ...
        {
          id: 'breakdown',
          title: lang === 'ar' ? 'Breakdown' : 'Breakdown',
